...
const EglContractV1b = artifacts.require("./EglContractV1b.sol");
...
contract("EglVotingV1bTests", (accounts) => {
    [
        _deployer, 
        _genesisOwner, 
        _seedAccount1, 
    ...
    beforeEach(async () => {             
        ...
        eglContractInstance = await EglContractV1b.new();        
    ...
    describe("Map Coinbase Address", function () {
        it("should not be able to enter 0 as designated address", async () => {
            await expectRevert(
                eglContractInstance.mapMinerAddress(ZERO_ADDRESS,{ from: _voter2 }),
                "EGL:INVALID_DESIGNATED_ADDR"
            )
        });
        it("should map miner address", async () => {
            let txReceipt = await eglContractInstance.mapMinerAddress(_voter1,{ from: _voter2 })
            ...
            let mappedAddress = await eglContractInstance.minerAddresses(_voter2)
