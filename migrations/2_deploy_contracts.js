...
const { 
    giveFreeTokens,
} = require("../test/helpers/helper-functions")
...
module.exports = async function (deployer, network, accounts) {    
    ...
    console.log(`EGL Token deployed to address: ${ConsoleColors.GREEN}`, eglToken.address);
    ...
    if (network === "ganache") {
        ...
        console.log(`UniSwap Factory deployed to address: ${ConsoleColors.GREEN}`, factoryContract.address);
        ...
        console.log(`UniSwap Router deployed to address: ${ConsoleColors.GREEN}`, routerContract.address);
    ...
    console.log(`EGL Contract deployed to address: ${ConsoleColors.GREEN}`, eglContract.address);
    console.log("");
    console.log(`Total EGL's gifted: ${ConsoleColors.CYAN}`, 
        parseFloat(
            web3.utils.fromWei(eglsGifted.toString())
        ).toLocaleString(
            'en-US',
            {
